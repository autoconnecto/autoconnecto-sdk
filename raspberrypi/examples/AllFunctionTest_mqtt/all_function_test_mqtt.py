#!/usr/bin/env python3
"""AllFunctionTest_mqtt — Raspberry Pi (pairs with ESP32 example of same name)."""
...
def main() -> None:
    ...
    print("[SDK] AllFunctionTest_mqtt started (raspberrypi)")
    last_telemetry = 0.0
    last_status = 0.0
    last_attr = 0.0
    ...
    try:
        while True:
            ...
            if now - last_status >= 30:
                last_status = now
                print("[STATUS] transport=MQTTS platform=raspberrypi")
