// =============================================================
// SwitchControl_http — HTTPS device-token API (ESP32)
//
// Pair sketch: examples/SwitchControl_mqtt/SwitchControl_mqtt.ino
//
// PURPOSE
//   Same widgets and keys as SwitchControl_mqtt. Shared
...
void setup() {
  ...
  Serial.println("[HTTP] SwitchControl_http started");
}
...
void loop() {
  ...
  if (now - lastAttrReport > 30000) {
    ...
    Serial.printf("[CLIENT ATTR batch] %d\n", code);
  }
