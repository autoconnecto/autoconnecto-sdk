// =============================================================
// AllFunctionTest_lte_ppp_mqtt — AllFunctions over LTE PPP (EC200)
//
// Same app logic as AllFunctionTest_mqtt; network is cellular PPP
// (ESP32 core PPP library), MQTTS :8883 — not WSS.
//
// REQUIRED: build_opt.h in this folder (-DAUTOCONNECTO_ENABLE_LTE_PPP=1)
// REQUIRED: ESP32 Arduino core 3.x
// See: LTE_PPP_EC200.md
//
// Pair sketch: examples/AllFunctionTest_mqtt/AllFunctionTest_mqtt.ino (WiFi)
// =============================================================
...
void onRPC(const String& method, JsonObject payload) {
  ...
  if (method == "getStatus") {
    ...
    reply["wifiRSSI"]      = sdk.getNetworkRssi();
...
void setup() {
  ...
  // ---- Transport (LTE uses MQTTS; WSS not used) ----
  ...
  Serial.println("[SDK] AllFunctionTest_lte_ppp_mqtt started");
}
